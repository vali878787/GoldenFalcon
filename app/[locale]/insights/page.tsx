    ...
    <>
      <main className="relative min-h-screen overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none -z-40">
          <div className="absolute -left-40 -top-40 h-175 w-175 rounded-full bg-[#0F2E4D]/6 blur-[180px]" />
          <div className="absolute -right-37.5 -bottom-37.5 h-125 w-125 rounded-full bg-[#D4AF37]/5 blur-[170px]" />
        </div>

        <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-175 w-175 rounded-full bg-[#0F2E4D]/5 blur-[200px] pointer-events-none -z-30" />

        <div className="fixed inset-0 flex items-center justify-center pointer-events-none -z-20">
          <img
            src="/LOGO-WATERMARK.png"
            alt=""
            className="w-[70vw] max-w-225 opacity-[0.3] select-none"
          />
        </div>
